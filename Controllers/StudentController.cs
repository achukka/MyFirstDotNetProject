...
namespace ContosUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstName,EnrollmentDate")] Student student)
        {
            ...
            {
                Console.WriteLine(dex.ToString() + " at Line 53");
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(studentToUpdate, "", new string[] { "LastName", "FirstName", "EnrollmentDate" }))
            {
                ...
                catch (DataException dex)
                {
                    ...
                    Console.WriteLine("At Line " + lineNumber + "The expection is:" + dex);
                    ModelState.AddModelError("", "Unable to Save changes.Try again, and if the problem persists, see your system administrator.");
                }
            }
        ...
        public ActionResult Delete(int? id, bool? saveChangesError = false)
        {
            ...
            {
                ViewBag.ErrorMessage = "Delelte failed.Try again, and if the problem persists see your system administrator.";
            }
        ...
        public ActionResult Delete(int id)
        {
            ...
            {
                int lineNumber = (new System.Diagnostics.StackFrame(0, true)).GetFileLineNumber();
                Console.WriteLine(dex.ToString() + " at Line " + lineNumber);
